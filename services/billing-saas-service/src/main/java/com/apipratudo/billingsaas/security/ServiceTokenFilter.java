package com.apipratudo.billingsaas.security;

import com.apipratudo.billingsaas.config.SecurityProperties;
import com.apipratudo.billingsaas.error.ErrorResponse;
...
public class ServiceTokenFilter extends OncePerRequestFilter {
  ...
  protected boolean shouldNotFilter(HttpServletRequest request) {
    ...
    return "OPTIONS".equalsIgnoreCase(request.getMethod())
        ...
        || path.equals("/internal/pix/webhook");
  }
